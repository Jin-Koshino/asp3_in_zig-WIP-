...
fn configuration(comptime cfg: *CfgData) void {
    ...
    cfg.CRE_TSK("TASK1", CTSK(TA_FPU | TA_ACT, 1, task1, LOW_PRIORITY, STACK_SIZE, null));
    cfg.CRE_TSK("TASK2", CTSK(TA_FPU, 2, task2, MID_PRIORITY, STACK_SIZE, null));
    cfg.CRE_TSK("TASK3", CTSK(TA_NULL, 3, task1, MID_PRIORITY, STACK_SIZE, null));
    cfg.CRE_TSK("TASK4", CTSK(TA_NULL, 4, task1, HIGH_PRIORITY, STACK_SIZE, null));
