...
pub const CP15_ACTLR_SMP =
    if (arm.isEnabled(arm.Feature.has_v7)) 0x00000040 else 0x00000020;
pub const CP15_ACTLR_FW =
    if (arm.isEnabled(arm.Feature.has_v7)) 0x00000001 else @compileError("not supported.");
...
pub const SCU_CTRL = @ptrFromInt(*u32, SCU_BASE + 0x00);
pub const SCU_CONFIG = @ptrFromInt(*u32, SCU_BASE + 0x04);
pub const SCU_CPUSTAT = @ptrFromInt(*u32, SCU_BASE + 0x08);
pub const SCU_INVALL = @ptrFromInt(*u32, SCU_BASE + 0x0c);
...
pub const TMR_LR = @ptrFromInt(*u32, TMR_BASE + 0x00);
pub const TMR_CNT = @ptrFromInt(*u32, TMR_BASE + 0x04);
pub const TMR_CTRL = @ptrFromInt(*u32, TMR_BASE + 0x08);
pub const TMR_ISR = @ptrFromInt(*u32, TMR_BASE + 0x0c);
pub const WDG_LR = @ptrFromInt(*u32, TMR_BASE + 0x20);
pub const WDG_CNT = @ptrFromInt(*u32, TMR_BASE + 0x24);
pub const WDG_CTRL = @ptrFromInt(*u32, TMR_BASE + 0x28);
pub const WDG_ISR = @ptrFromInt(*u32, TMR_BASE + 0x2c);
pub const WDG_RST = @ptrFromInt(*u32, TMR_BASE + 0x30);
pub const WDG_DIS = @ptrFromInt(*u32, TMR_BASE + 0x34);
...
pub const GTC_COUNT_L = @ptrFromInt(*u32, GTC_BASE + 0x00);
pub const GTC_COUNT_U = @ptrFromInt(*u32, GTC_BASE + 0x04);
pub const GTC_CTRL = @ptrFromInt(*u32, GTC_BASE + 0x08);
pub const GTC_ISR = @ptrFromInt(*u32, GTC_BASE + 0x0c);
pub const GTC_CVR_L = @ptrFromInt(*u32, GTC_BASE + 0x10);
pub const GTC_CVR_U = @ptrFromInt(*u32, GTC_BASE + 0x14);
pub const GTC_AUTOINCR = @ptrFromInt(*u32, GTC_BASE + 0x18);
