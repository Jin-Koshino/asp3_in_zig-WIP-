///
///  データキュー機能のテスト(1)のシステムコンフィギュレーション記述
///
///  $Id$
///
...
fn configuration(comptime cfg: *CfgData) void {
    ...
    cfg.CRE_DTQ("DTQ1", CDTQ(TA_NULL, 2, null));
    cfg.CRE_DTQ("DTQ2", CDTQ(TA_NULL, 0, null));
    cfg.CRE_DTQ("DTQ3", CDTQ(TA_TPRI, 2, null));
}
